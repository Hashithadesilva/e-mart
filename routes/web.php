...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])
    ...
    ->name('stripe.')
    ->group(function () {
        // Show the order summary & "Pay with Stripe" page
        Route::get('/pay/{orderId}',     [StripeController::class, 'pay'])->name('pay');
        // Create a Stripe Checkout Session and redirect to Stripe
        Route::post('/session/{orderId}', [StripeController::class, 'createSession'])->name('session');
